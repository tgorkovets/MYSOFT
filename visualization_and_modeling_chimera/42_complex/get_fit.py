...
# for str_post in range(-3,-2):
	...
	rc('matrixset ~/junk/m2.dat')
	rc('fitmap #0 #1 resolution 20 metric overlap envelope false search 30 placement r listFits true')
	
	# rc('fitmap #0 #1 resolution 5 metric overlap envelope false')
